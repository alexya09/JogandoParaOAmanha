...
if(botao_pressionado)
{
	...
	draw_sprite_ext(sSetaBaixo,0,450,75,0.7,0.7,0,c_white,1);
	if(localadc == 1)
	//draw_sprite(sSetaBaixo,1,447,149);
	draw_sprite_ext(sSetaBaixo,0,450,116,0.7,0.7,0,c_white,1);
	if(localadc == 2)
	//draw_sprite(sSetaBaixo,1,447,203);
	draw_sprite_ext(sSetaBaixo,0,450,157,0.7,0.7,0,c_white,1);
	if(localadc == 3)
	//draw_sprite(sSetaBaixo,1,447,257);
	draw_sprite_ext(sSetaBaixo,0,450,199,0.7,0.7,0,c_white,1);
	if(localadc == 4)
	draw_sprite_ext(sSetaBaixo,0,450,240,0.7,0.7,0,c_white,1);
}
*/